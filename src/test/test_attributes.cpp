...
Test(attributes, count_triples) {
  ...
  cr_assert_eq(3, virtual_addressing::attributes::metadata::getting::real_length( a));
  cr_assert_eq(10, virtual_addressing::attributes::metadata::getting::virtual_length( a ));
}
